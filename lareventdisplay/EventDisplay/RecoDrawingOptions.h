...
namespace evd {
  ...
  public:
    ...
    std::vector<art::InputTag>
      fEndPoint2DLabels;                       ///< module labels that produced end point 2d objects
    ...
    std::vector<art::InputTag>
      fTrkVtxTrackLabels; ///< module labels that produced tracks (Track/Vertex module)
    std::vector<art::InputTag>
      fTrkVtxCosmicLabels; ///< module labels that tagged track as CR (Track/Vertex module)
    std::vector<art::InputTag>
      fTrkVtxFilterLabels; ///< module labels that filtered event (Track/Vertex module)
