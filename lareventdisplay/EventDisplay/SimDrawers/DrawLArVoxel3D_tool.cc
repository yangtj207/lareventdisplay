...
//......................................................................
int DrawLArVoxel3D::GetMCTruth(const art::Event& evt, std::vector<const simb::MCTruth*>& mcvec) const
{
    mcvec.clear();
    ...
    try{
        ...
        mf::LogWarning("DrawLArVoxel3D") << "GetMCTruth:" << " failed with message:\n" << e;
    }
